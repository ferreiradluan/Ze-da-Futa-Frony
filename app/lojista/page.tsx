...
export default function LojistaHomePage() {
  return (
    <>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
        <div className="grid auto-rows-min gap-4 md:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">R$ 1.247</div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Comparado ao mês passado</p>
            </CardContent>
          </Card>
        </div>
        <div className="min-h-[100vh] flex-1 rounded-xl bg-muted/50 md:min-h-min p-4">
          ...
          <p className="text-muted-foreground">
            Bem-vindo ao seu painel de controle. Aqui você pode gerenciar seus pedidos, produtos e acompanhar suas
            vendas.
          </p>
        </div>
      </div>
